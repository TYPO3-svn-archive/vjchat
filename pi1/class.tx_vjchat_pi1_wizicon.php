...
class tx_vjchat_pi1_wizicon {
	...
	function proc($wizardItems)	{
		...
		$wizardItems['plugins_tx_vjchat_pi1'] = array(
			'icon'=>t3lib_extMgm::extRelPath('vjchat').'pi1/ce_wiz.gif',
	...
	/**
	 * Includes the locallang file for the 'vjchat' extension
	 * 
	 * @return	array		The LOCAL_LANG array
	 */
	function includeLocalLang()	{
		include(t3lib_extMgm::extPath('vjchat').'locallang.php');
		return $LOCAL_LANG;
	}
}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/vjchat/pi1/class.tx_vjchat_pi1_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/vjchat/pi1/class.tx_vjchat_pi1_wizicon.php']);
}
?>